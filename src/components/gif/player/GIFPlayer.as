...
{	
	...
	import components.gif.frames.GIFFrame;
	import components.gif.decoder.GIFDecoder;
	import components.gif.events.GIFPlayerEvent;
	import components.gif.events.FrameEvent;
	import components.gif.events.TimeoutEvent;
	import components.gif.events.FileTypeEvent;
	import components.gif.errors.FileTypeError;
