package Basic
{
	...
	public class Api extends EventDispatcher
	{
		...
		public var domain: String = "http://api.linden.pro/";
...
//		}
		...
		public function getLibraryResult(ev:Event): void{
		...
		public function getPage(book:String,page:Number,resolution:Number): void{
			var urlLoader:URLLoader = new URLLoader();
		...
		public function getPageResult(ev:Event): void{
		...
		public function getTokenResult(e:Event): void {
			...
			if(data.hasOwnProperty("token")){
				...
				var _ev:LoginResultEvent = new LoginResultEvent(LoginResultEvent.LOGIN_FAIL,this.email,this.password);
				dispatchEvent(_ev);				
			}
		}
		
		public function getBook(book:String): void{
			var urlLoader:URLLoader = new URLLoader();
			//http://api.linden.pro/book-page/5/2?width=1200&add_book_page_items=1&add_book_page_words=1&token=asf
		...
		public function getBookResult(ev:Event): void {
			var res:Object = com.adobe.serialization.json.JSON.decode(ev.target.data);
		...
		public function getThumbnailsOfBook(book:String): void {
		...
		public function getBookThumnbnailsResult(ev:Event): void {
		...
		public function getItemUrl(itemId:String): String{
